...
testing("autocryptSetup.jsm"); /*global EnigmailAutocryptSetup: false */
...
test(withTestGpgHome(withEnigmail(function keyGenTest() {
  ...
  let keygenRequest = EnigmailAutocryptSetup.startKeyGen(headerValue);
  Assert.notEqual(keygenRequest, null);
  keygenRequest.wait();
